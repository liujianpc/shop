...
<div class="block clearfix" style="background-color:#FFFFFF; margin-bottom:10px; padding-bottom:3px; padding-top:10px">
<div class="block2 clearfix">
 <div id="userLeft" class="fl">
 <?php echo $this->fetch('library/user_menu.lbi'); ?>
 </div>
 <div id="userRight" class="fr" style="overflow:hidden;">
 ...
 <?php if ($this->_var['action'] == 'default'): ?>
  ...
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
	...
	<?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
	 <?php endif; ?>
	 <div class="us_notice">
	 <img src="themes/68ecshop_xiaomifree/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
	 </div>
 ...
 <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onsubmit="return submitMsg()">
  <table width="100%" border="0" cellpadding="3">
		...
		<tr>
			...
			<td>
			<a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/68ecshop_xiaomifree/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
 <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/68ecshop_xiaomifree/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php else: ?>
