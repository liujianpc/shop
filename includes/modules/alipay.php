...
//        }
   ...
   //         'logistics_fee'     => 0,
     ...
     //       'seller_email'      => $payment['alipay_account']
			  ...
			  'title'               => $GLOBALS['_LANG']['order_number'].'订单号:' . $order['order_sn'] ,
	...
	<form id="payment" accept-charset="utf-8" action="https://shenghuo.alipay.com/send/payment/fill.htm" method="post">
		...
		<input type="button" onclick="javascript:document.charset=\'utf-8\';document.getElementById(\'payment\').submit()" value="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
	// www.zuimoban.com 
